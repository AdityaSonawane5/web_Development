...
router.post("/", protect, async (req, res) => {
    ...
    try {
        ...
        console.log("Error Creting checkout session:", error);
...
// @route POST /api/checkout/:id/finalLize
// @desc Finalized checkout and covert to an order after payment confirmation
// @access Private
