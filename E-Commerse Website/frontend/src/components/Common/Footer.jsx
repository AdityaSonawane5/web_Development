    ...
    <footer className='border-t py-12'>
        <div className='container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0'>
            <div>
                ...
                <p className='text-gray-500 mb-4'>
                    be the first to hear about our Latest offer and products
                </p>
                <p className='font-medium text-sm text-gray-600 mb-6'>
                    Sign up and get 10% off your firat order
                </p>
                {/* Newsletter form */}
                <form className='flex'>
                    <input type="email" placeholder='Enter your email' className='p-3 w-full text-sm border-t border-l border-b  border-gray-300 rounded-l-md focus:outline-none focus:ring focus:ring-gray-500 transition-all' required/>
        ...
        <div className='container mx-auto mt-12  px-4 lg:px-0 border-t border-gray-200 pt-6'>
            <p className='text-gray-500 text-sm tracking-tighter text-center'>
                2025, ComileTable.All Rights Reserved.
            </p>
        </div>
    </footer>
  )
